...
public class MyWebSocketDecoder00 extends ReplayingDecoder<Void> implements WebSocketFrameDecoder {
	static final int DEFAULT_MAX_FRAME_SIZE = 16384;

	private final long maxFrameSize;
	private boolean receivedClosingHandshake;

	public MyWebSocketDecoder00() {
	 ...
	 */
	public MyWebSocketDecoder00(int maxFrameSize) {
